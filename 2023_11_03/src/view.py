...
class MyMainWindow(QMainWindow):
    def __init__(self):
        ...
        self.view_client.connect(("127.0.0.1", 12345))  # 서버 IP 주소와 포트 번호를 지정
        # 127.0.0.1 가 자신의 컴퓨터에서만 사용할 수 있게 하는 주소
        ...
        while True:
            ...
            if message == 'NAME':
                ...
                if '대기' in message:
                    ...
                    self.ui.lineEdit1.setText(wait_string)
                    ...
                    self.ui.lineEdit2.setText(complete_string)
